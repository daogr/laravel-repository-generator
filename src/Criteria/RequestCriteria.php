 ...
 * @package Otodev\Criteria
 */
class RequestCriteria implements CriteriaContract
{
    /**
     * @var Request
     */
    ...
    public function apply($model, RepositoryContract $repository)
    {
        ...
        if ($search && is_array($fieldsSearchable) && count($fieldsSearchable)) {
            ...
            $model = $model->where(function (Builder $query) use ($fields, $search, $searchData, $isFirstField, $modelForceAndWhere) {
