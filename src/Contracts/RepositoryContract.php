<?php
    ...
    interface RepositoryContract {
         ...
         * @param array $attributes
         * @param array $values
		 * @param bool  $transform Transforms the request data before create/update the resource
         *
         * @return Eloquent|Model|mixed
         */
        public function updateOrCreate(array $attributes, array $values = [], $transform = false);
